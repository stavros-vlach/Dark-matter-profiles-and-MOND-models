...
def newtonian_acceleration(r, Y_star):
...
def log_likelihood(theta):
	...
	Y_star = theta
	v_model_sq = mond_velocity_squared(r, v_disk_sq, v_bulge_sq, v_gas_sq, Y_star)
...
def chi_square(theta):
	Y_star = theta
	v_MOND_sq = mond_velocity_squared(r, v_disk_sq, v_bulge_sq, v_gas_sq, Y_star)
...
print(result)
v_MOND_sq_best = mond_velocity_squared(r, v_disk_sq, v_bulge_sq, v_gas_sq, Y_star_best)
...
v_model_sq_mcmc = mond_velocity_squared(r, v_disk_sq, v_bulge_sq, v_gas_sq, Y_star_mcmc)
